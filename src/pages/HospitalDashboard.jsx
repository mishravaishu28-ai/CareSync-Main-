...
const HospitalDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6">
        ...
        <div className="relative">
          ...
          {menuOpen && (
            <div className="absolute right-0 mt-2 w-48 bg-white shadow-lg rounded-xl border z-50">
              ...
              <button className="block w-full text-left px-4 py-2 hover:bg-gray-100">Hospitals</button>
              <button className="block w-full text-left px-4 py-2 hover:bg-gray-100">Emergency Cases</button>
      ...
      {/* LOADING STATE */}
      {loading ? (
        <div className="text-center text-lg font-bold text-gray-500 mt-20">
          Loading alerts...
        </div>
      ) : (
        <>
            ...
            {activeAlerts.map((alert) => (
              ...
              >
                ...
                <div className="space-y-1 text-gray-700">
                  ...
                  <p>
                    <b>Time:</b>{" "}
                    {alert.time?.toDate?.().toLocaleString() || "N/A"}
                  </p>
                </div>
